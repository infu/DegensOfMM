...
- [ ] Drive the remaining `submit_build_town_structure` floor from `0.7069B` into the `0.3B-0.6B` target range, or document the unavoidable residual cost with repo/method attribution.
