...
- [ ] Drive the remaining safe-guard town command floor from `1.4111B`/`0.7062B` into the `0.3B-0.6B` target range, or free enough code-size headroom for a safe runtime-open guard that avoids the two `system_jobs.by_session_status_due` scans.
