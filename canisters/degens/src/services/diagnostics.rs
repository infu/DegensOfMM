...
use domm_degens_schema::schema::{
    ...
    MapChunk, MapObjectDefinition, MapOccupancy, MovementIntent, MovementSnapshot, NeutralArmy,
    ...
    ResourceLedgerTurnSummary, RulesetDefinition, ScenarioRuleState, SpellDefinition,
